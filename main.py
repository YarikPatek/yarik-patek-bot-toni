...
"""
    ...
    connect = psycopg2.connect('postgres://ekigmvbjsrptip:f541b3f489959221c9b1efaed585d5b70d3588e00da073782082c16334a47f0a@ec2-52-212-228-71.eu-west-1.compute.amazonaws.com:5432/devhd41u5a0bjp', sslmode="require")
    ...
    if data is None:
        ...
        cursor.execute("INSERT INTO user_db VALUES(%s, %s);", user)
        connect.commit()
